public class Maggie
{
    ...
    {
        statement = statement.trim();
        String lastChar = statement.substring(statement.lenght() -1);
        if (lastChar.equals("."))
        {
            statement = statement.substring(0, statement.length() -1);
    ...
    {
        Maggie magpie = new Maggie();
        String statement = "I want a robot.";
        System.out.println("Statement: " + statement);
        System.out.println("Response: " + magpie.getResponse(statement));
    }
}
